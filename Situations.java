public class Situations extends TheGame {
    ...
    String attAns1 = "You decide to break up with them. But how?\n1. You treat the person to a nice "
            + "3-course meal. At the end, you say all the usual break-up \"It's not you, it's me and blah blah....\" and you break up!"
    ...
    String attractiveUPAYO12 = "WOAH! I am mindblown! This worked! I am just kidding. Of course it didn't work, this person is\n"
    ...
    String attractiveUPAYO33 = "Are you trolling right now? What exactly do you plan to accomplish by calling a government representative? They have more\n" +
            "important problems to deal with! You eventually have to go to school. Also, the principal of your school was notified of this \"waste of precious congressional time\"\n" +
            "and contacted your parents. Your parents grounded you for a year.";
    ...
    String attractiveUPAYO112 = "They don't stop calling you, driving you deeper and deeper into madness; the restraining order has not helped.";
    ...
    public void nextSitForAtt12(int a)
    {
        if(a==1)
        {
    ...
    public void nextSitForAtt13(int a)
    {
        if(a==1)
        {
    ...
    public void nextSitForAtt21(int a)
    {
        if(a==1)
        {
    ...
    public void nextSitForAtt22(int a)
    {
        if(a==1)
        {
    ...
    public void nextSitForAtt23(int a)
    {
        if(a==1)
        {
    ...
    public void nextSitForAtt31(int a)
    {
        if(a==1)
        {
    ...
    public void nextSitForAtt32(int a)
    {
        if(a==1)
        {
    ...
    public void nextSitForAtt33(int a)
    {
        if(a==1)
        {
